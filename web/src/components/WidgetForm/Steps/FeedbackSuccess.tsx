...
interface FeedbackSucccessStepProps{
    onFeedbackRestarRequested: () => void; 
}

export function FeedbackSucccessStep( {onFeedbackRestarRequested}: FeedbackSucccessStepProps) {
    return (
        <>
            <header>
                <CloseButton />
            ...
            <div className="flex flex-col items-center py-10 w[304px]">
                ...
                focus:ring-purple-500 disabled:opacity-50 disabled:hover:bg-purple-500">
                    Quero enviar outro!
                </button>
